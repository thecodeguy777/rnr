...
export const products: Product[] = [
  ...
  // ── Pendants ──
  {
    ...
    weightGrams: 5.6,
    price: 28000,
    description: 'A perfectly formed teardrop in polished 18K gold. Catches the light from every angle with its smooth, organic curves.',
    craftsmanshipNotes: 'Hand-formed from a single gold bead, gradually shaped into its teardrop silhouette through patient hammering and polishing.',
    images: [
      'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80',
      'https://images.unsplash.com/photo-1602752250015-52934bc45613?w=800&q=80',
    ],
  ...
  {
    id: 'pend-002',
    name: 'Coin Medallion Pendant',
    collection: 'pendants',
    karat: '21K',
    weightGrams: 8.2,
    price: 52000,
    description: 'Inspired by ancient Filipino gold coins. A substantial medallion that carries the weight of history and heritage.',
    craftsmanshipNotes: 'Cast using the lost-wax method, then hand-engraved with traditional motifs. Each medallion is unique.',
    images: [
      'https://images.unsplash.com/photo-1602752250015-52934bc45613?w=800&q=80',
      'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80',
    ],
  ...
  },
  {
    ...
    weightGrams: 4.8,
    price: 22000,
    description: 'A classic heart locket that opens to hold a precious photo. Sentimental jewelry at its finest.',
    craftsmanshipNotes: 'Two-piece construction with a precision hinge. The interior is polished smooth to protect whatever memory you choose to keep inside.',
    images: [
      'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80',
      'https://images.unsplash.com/photo-1602752250015-52934bc45613?w=800&q=80',
    ],
  ...
  },
  {
    ...
    weightGrams: 6.5,
    price: 32000,
    description: 'A timeless cross pendant with clean lines and a satin finish. Faith and craftsmanship united in gold.',
    craftsmanshipNotes: 'Precision-cut from a solid gold sheet, then hand-finished with alternating polished and satin textures.',
    images: [
      'https://images.unsplash.com/photo-1602752250015-52934bc45613?w=800&q=80',
      'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80',
    ],
